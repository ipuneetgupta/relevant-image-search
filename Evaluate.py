...
# load trainset
trainFile = '/var/www/html/TextBasedImageSearch/Dataset/Flickr8k_text/Flickr_8k.trainImages.txt'
train = Loader.load_set(trainFile)
print('Dataset: %d' % len(train))
# descriptions
train_descriptions = Loader.load_clean_descriptions('/var/www/html/TextBasedImageSearch/Dataset/descriptions.txt',
                                                    train)
print('Descriptions: train=%d' % len(train_descriptions))
# photo features
train_features = Loader.load_photo_features('/var/www/html/TextBasedImageSearch/Dataset/features_resnet.pkl', train)
...
# load test set
testImgList = dataset_root_dir + 'Flickr8k_text/Flickr_8k.testImages.txt'
...
# photo features
test_features = Loader.load_photo_features('/var/www/html/TextBasedImageSearch/Dataset/features_resnet.pkl', testImg)
